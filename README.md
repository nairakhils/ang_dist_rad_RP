...
A Jupyter notebook for visualizing the **angular distribution of radiation** emitted by an accelerated charge moving at relativistic velocities. This project explores how radiation patterns depend on the charge's velocity and acceleration direction, demonstrating key relativistic effects like beaming and the headlight effect.
